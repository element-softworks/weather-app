...
const initialState =
	JSON.parse(localStorage.getItem('temperaturePreference') as string)?.prefersCelsius ?? true;
const temperatureReducer = (_: any, prefersCelsius: boolean) => {
	return prefersCelsius;
};
 ...
 */
const TemperatureContext: Context<ITemperatureContext> = React.createContext(
	{} as ITemperatureContext
);
